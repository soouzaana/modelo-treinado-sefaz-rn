...
class CacheData:
    ...
    def __collect_data(self, lines, base_path, error_files, is_file=False):
        ...
        # sorted() em vez de list(set(...)): set() em Python tem ordem
        # dependente do hash da string, que é randomizado por processo.
        # Se o CharSet mudar de ordem entre execuções (ex: rodar cache de
        # novo com checkpoints já existentes), o mapeamento char->index
        # do checkpoint antigo fica incompatível com o novo config.yaml e
        # o treino retomado nunca sai de accuracy ~0.
